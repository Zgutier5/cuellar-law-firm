...
class ServicesPageSpanish extends Component {
  render() {
    return (
      <div>
        {/*<TitleBanner color="black" title="Servicios Ofrecidos" />*/}
        <ProfileTitle color="#06b9dd" title="Servicios Ofrecidos"/>
...
export default ServicesPageSpanish;
